...
brick = media.Movie("Brick",
					"Film noir/gumshoe. A high school student works to find "
...
the_shawshank_redemption = media.Movie("The Shawshank Redemption",
										"A man finds redemption behind prison "
										"walls.",
										poster_folder + "the-shawshank-"
										"redemption.jpg",
...
interstellar = media.Movie("Interstellar",
							"Humanity struggles to survive, as the Earth's"
							" crops fail.",
...
a_fistful_of_dollars = media.Movie("A Fistful of Dollars",
									"A man with no name, a town with a bloody "
									"feud.\nA boy cries.",
